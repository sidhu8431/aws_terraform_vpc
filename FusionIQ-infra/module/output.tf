output "vpc_id" {
  value = module.fusioniq_vpc.vpc_id # Ensure this matches the actual resource name
}

output "subnet_private" {
  value = module.fusioniq_vpc.subnet_private
}
output "subnet_private_database" {
  value = module.fusioniq_vpc.subnet_private_database
}

output "subnet_public" {
  value = module.fusioniq_vpc.public_subnet_ids
}
